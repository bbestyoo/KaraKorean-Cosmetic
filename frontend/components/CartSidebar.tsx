  ...
  return (
    <>
      ...
      {isOpen && (
        <>
          <div
            className="fixed inset-0 bg-black/30 z-40 cart-overlay-fade"
            onClick={closeCart}
          ></div>

          <div className="fixed right-0 top-0 h-full w-full max-w-[500px] bg-[#f7f7f7] shadow-2xl z-50 flex flex-col font-mono cart-slide-in">
            {/* Header */}
